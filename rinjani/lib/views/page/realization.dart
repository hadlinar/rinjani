...
class Realization extends StatefulWidget{
  SuccessAddRealization successAddRealization;

  Realization({this.successAddRealization});
...
class _Realization extends State<Realization> {
  ...
  void initState() {
    ...
    cust = [];
    position = [];
    BlocProvider.of<VisitBloc>(context).add(GetVisitByIdEvent('2014457001'));
  }
            ...
            if (state is InitialVisitBlocState || state is LoadingVisitState) {
              ...
              for(int i=0; i<state.getVisit.length;i++) {
                ...
                setState(() {
                  ...
                  cust.add(state.getVisit[i].cust_id);
              ...
              widget.successAddRealization(200, context);
            }
            else {
              Container();
            }
