                                    ...
                                    InkWell(
                                        onTap: (){
                                          Navigator.push(context, MaterialPageRoute(
                                              builder: (context) => ListCustomer(state.getVisitRealization)
                                          ));
                                        },
                                ...
                                Row(
                                  ...
                                  children: <Widget>[
                                    InkWell(
                                        onTap: (){
                                          Navigator.push(context, MaterialPageRoute(
                                              builder: (context) => ListVisit(state.getVisitRealization)
                                          ));
                                        },
                                              ...
                                              title: Container(
                                                child: Column(
                                                    children: <Widget>[
                                                      Align(
                                                        alignment: Alignment.centerLeft,
                                                        child: Text(state.getVisitRealization[i].cust_id, style: Global.getCustomFont(Global.BLACK, 14, 'bold')),
                                                      ),
                                                      Container(
                                                        padding: const EdgeInsets.only(top: 5),
                                                        child: Align(
                                                          alignment: Alignment.centerLeft,
                                                          child: Text(state.getVisitRealization[i].pic_name, style: Global.getCustomFont(Global.BLACK, 14, 'medium')),
                                                        ),
                                                      ),
                                                      Divider()
                                                    ]
