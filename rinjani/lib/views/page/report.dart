...
import 'package:rinjani/widget/pie_chart.dart';
...
class _Report extends State<Report> {
  ...
  void initState() {
    ...
    // BlocProvider.of<RankBloc>(context).add(GetRankEvent("lowest"));
    // BlocProvider.of<RankBloc>(context).add(GetRankEvent("highest"));
    String branchUser = store.get("branch_id");
    // BlocProvider.of<ActivityBloc>(context).add(GetActivityEvent(branchUser));
  }

  Widget reportOp(BuildContext context, String id){
    BlocProvider.of<VisitBloc>(context).add(GetRealizationOpEvent(id, "year"));
    BlocProvider.of<ActivityBloc>(context).add(GetActivityEvent(id));
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            Container(
                              ...
                              //           child: CircularProgressIndicator()
                              //       );
                              //     } else if (state is GetRankLowState) {
                              //       return Rank();
                              //     } else if (state is GetRankHighState) {
                              //       return Rank();
                              //     } else {
                              //       return Container();
                              //     }
