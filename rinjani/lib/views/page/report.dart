...
//     BlocProvider.of<VisitBloc>(context).add(GetVisitRealizationByIdEvent('123'));
...
//                   //       print(state.getVisitRealization.length);
//                   //
//                   //     } else {
//                   //       Container();
//                   //     }
...
//                               if (state is InitialVisitBlocState || state is LoadingVisitState) {
//                                 Center(child: CircularProgressIndicator());
//                               } else if (state is VisitRealizationList) {
//                                 print(state.toString());
//                                 print(state.getVisitRealization.length);
//                               } else {
//                                 Container();
...
//                                     padding: const EdgeInsets.only(top: 7),
//                                     child: ListView.builder(
//                                       // itemCount: state.getCustomer.length,
//                                         scrollDirection: Axis.vertical,
//                                         shrinkWrap: true,
//                                         physics: NeverScrollableScrollPhysics(),
//                                         itemBuilder: (context, i){
...
//                                                         child: Align(
//                                                           alignment: Alignment.centerLeft,
//                                                           child: Text("state.getCustomer[i].cust_name", style: Global.getCustomFont(Global.BLACK, 14, 'medium')),
//                                                         ),
//                                                       ),
//                                                       Divider()
//                                                     ]
